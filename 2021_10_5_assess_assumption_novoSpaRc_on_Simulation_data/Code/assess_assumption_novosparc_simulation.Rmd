...
```{r cars}
original_positions <- read.csv("~/simulldata_locs.txt", sep="")
...
novosparc_distance_matrix <- read.csv("C:/Users/deand/OneDrive/Documents/cortex_data/novosparc_files/normalized_mouse_sim_LR.csv", row.names=1)
