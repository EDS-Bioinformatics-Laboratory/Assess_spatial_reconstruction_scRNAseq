...
```{r cars}
raw_expression_counts_liver_lobules_genes_splitted_capital_genes <- read.delim2("~/cortrex_counts_with_capital_names.txt")
...
raw_expression_counts_liver_lobules_genes_splitted_capital_genes<-raw_expression_counts_liver_lobules_genes_splitted_capital_genes[,-c(1,2)]      
...
raw_expression_counts_liver_lobules_genes_splitted_capital_genes <-  read.delim2("C:/Users/deand/OneDrive/Documents/cortex_data/cortrex_counts_with_capital_names.txt")
...
View(gene_data_frame)
write.table(gene_data_frame,'C:/Users/deand/OneDrive/Documents/gendata_seqfish.txt')
...
write.table(expression2,'C:/Users/deand/OneDrive/Documents/CSOmap/data/TPM_mouse_seqfish.txt')
```
