...
```{r cars}
cell_names <- read.table("~/reproduce_liver_analysis/cell_names.txt", quote="\"", comment.char="")
novosparc_distance_matrix <- read.csv("C:/Users/deand/OneDrive/Documents/Liver_lobules/novosparc_files/normalized_mouse_liver_LR.csv", row.names=1)
